...
/**
 * 当前的类是一个user的持久化类，它映射到数据库db_shf中的表user
 * 
 * @Table(name = "user", catalog = "db_shf") 在实体名和表名相同的情况下可以省略（忽略大小写）
 * 
 ...
 */
@Entity
@Table(name = "user", catalog = "springmvc", uniqueConstraints = {@UniqueConstraint(columnNames={"username"})})
