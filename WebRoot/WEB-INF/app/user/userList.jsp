...
<meta name="viewport" content="width=device-width, initial-scale=1.0" />
	...
	<link href="/plugins/jquery/page/page.css" rel="stylesheet" type="text/css" />
	<link href="/plugins/jquery/msgbox/msgbox.css" rel="stylesheet" type="text/css" />
	<script src="/plugins/jquery/jquery-1.10.2.js"></script>
	<script src="/plugins/bootstrap/js/bootstrap.min.js"></script>
	<script type="text/javascript" src="/plugins/jquery/page/jquery.myPagination5.0.js"></script>
	<script type="text/javascript" src="/plugins/jquery/msgbox/msgbox.js"></script>
	<script type="text/javascript" src="/plugins/jquery/time.js"></script>
	...
	<script type="text/javascript">
		...
		function deleteUser() {
			...
			$.ajax("/user/deleteUser?userId=" + id + "");
								...
								$("#userTable > tbody").html(""); //每次加载的时候先设为空
									$.each(data.event,function(i, value) {
										$("#userTable > tbody").append("<tr><td>"
												...
												+ "<a href=\"/user/deleteUser?userId=" + value.id + "\" class=\"btn btn-danger btn-xs active\" role=\"button\">Delete</a>"
												+ "</td>"
												+ "</tr>");
									});
...
<body>
	<div class="container">
		<a href="/user/exit" class="btn btn-link pull-right"
			role="button">Exit</a>
		...
		<div class="modal fade" id="updateWin" tabindex="-1" role="dialog"
			aria-labelledby="myModalLabel" aria-hidden="true">
			<div class="modal-dialog">
				<form class="form-horizontal" action="/user/updateUser" role="form" method="post">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal"aria-hidden="true">&times;</button>
